...
\item TRIBAL addresses these challenges by offering a unified platform for roommate matching based on compatibility, activity partner discovery, event participation, and secure in-app chat.
...
\begin{itemize}
  \item To develop a mobile platform that helps users find compatible roommates by evaluating lifestyle preferences through a compatibility scoring system.
  \item To provide a platform where users can create, browse, and join local events to encourage community engagement.
  \item To facilitate secure one-to-one communication between matched users through an in-app real-time chat system.
\end{itemize}
